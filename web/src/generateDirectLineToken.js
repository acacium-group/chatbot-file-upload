...
module.exports = async function generateDirectLineToken(botUrl, botId, botTenantId) {
  ...
  const response = await fetch(botUrl + '&botId=' + botId + '&tenantId=' + botTenantId, {method: "GET"});
